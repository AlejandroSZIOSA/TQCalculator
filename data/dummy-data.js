...
export const ZONE = [
  new Zone('1',"Stockholm",["s1","s2","s3","s4"]),
  new Zone('2',"Malmö",["s3","s4"]),
  new Zone('3',"Helsingborgs",["s5","s6","s1"]), //problem solved array "s5" not 's5' :)
  new Zone('4',"Ekerö",["s3","s1","s5"]),
  new Zone('5',"Sigtuna",["s4","s3","s6","s2"])
]
export const SEED = [
